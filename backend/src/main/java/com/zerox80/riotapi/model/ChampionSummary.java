...
/**
 * Data model representing summary information about a League of Legends
 * champion.
 * Contains basic champion metadata for list views and champion selection
 * interfaces.
 *
 * This model provides essential champion information without the detailed lore
 * and ability data found in ChampionDetail. Used for champion lists, search
 * results,
...
public class ChampionSummary {
    ...
    // The Data Dragon version (e.g., "14.19.1")
     ...
     */
    public ChampionSummary(String id, String name, String title, List<String> tags, String imageFull, String version) {
        this.id = id;
        this.name = name;
        this.title = title;
        this.tags = tags;
