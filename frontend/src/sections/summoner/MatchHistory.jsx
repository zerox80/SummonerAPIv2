    ...
    <section className="match-history glass-panel">
      ...
      <div className="match-history__list">
        {filteredMatches.map((match) => {
          ...
          const rawDuration = match.info.gameDuration || match.info.gameDurationSeconds || 0;
          const durationSeconds = rawDuration > 10000 ? Math.round(rawDuration / 1000) : Math.round(rawDuration);
