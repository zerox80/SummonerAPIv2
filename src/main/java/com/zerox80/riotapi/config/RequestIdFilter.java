...
/**
 * Sets a per-request correlation ID in MDC and response headers.
 *
 * - Reads existing X-Request-Id header, otherwise generates a UUID.
 * - Exposes it as response header X-Request-Id.
 * - Stores it in MDC under the key "requestId" for log correlation.
 */
@Component
